...
static const char* MODEL_NUMBER = "Nano 33 BLE";
...
static const char* ENVIRONMENTAL_SENSING_UUID = "0000181a-0000-1000-8000-00805f9b34fb";
static const char* TEMPERATURE_UUID = "00002a6e-0000-1000-8000-00805f9b34fb";
static const char* HUMIDITY_UUID = "00002a6f-0000-1000-8000-00805f9b34fb";
...
uint16_t current_index = 6;

constexpr int label_count = 4;
const char* labels[label_count] = {"Hour Glass", "Heart", "Lumos", "Shield Aura"};
...
//    }
  ...
  if (done_just_triggered) {
    ...
    current_index = max_index*100;
  }
  
  if (currentMillis - previousMillis > interval) {
    previousMillis = currentMillis;
    humidityCharacteristic.writeValue(current_index);
